  ...
  switch (state.step) {
    ...
    case "askWeight":
      ...
      if (text === "Не думаю") {
        bot.sendMessage(
          chatId,
          "Такие тяжёлые заказы - редкое явление. В основном, не более 10% от общего числа. Однако все курьеры-партнёры периодически их доставляют. Если будешь готов, мы можем всегда начать сначала.",
          {
            reply_markup: {
              keyboard: [
                [{ text: "Вернуться в начало ↩️" }],
